...
alias pui='pnpm update --interactive --latest -r --include-github-actions'
...
if [ -n "$container" ]; then
  ...
  export GIT_CONFIG_PARAMETERS="'core.hooksPath=/home/ai/Projects/env/hooks-trap'"
  ...
  # Zed
  alias e='~/Projects/env/bin/zed-isolate .'
